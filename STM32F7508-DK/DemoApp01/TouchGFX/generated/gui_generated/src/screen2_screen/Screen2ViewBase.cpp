    ...
    buttonCallback(this, &Screen2ViewBase::buttonCallbackHandler)
{
    ...
    dynamicGraph1.setGraphRangeY(0, 1000);
    ...
    dynamicGraph1MajorYAxisGrid.setInterval(200);
    ...
    dynamicGraph1MajorXAxisLabel.setLabelTypedText(touchgfx::TypedText(T___SINGLEUSE_GN6L));
    ...
    dynamicGraph1MajorYAxisLabel.setInterval(200);
    dynamicGraph1MajorYAxisLabel.setLabelTypedText(touchgfx::TypedText(T___SINGLEUSE_30JJ));
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_COEV));

    textArea2.setXY(23, 1);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_EMDS));
...
void Screen2ViewBase::handleTickEvent()
{
    ...
    if(frameCountUpdatePlotInterval == TICK_UPDATEPLOT_INTERVAL)
    {
        ...
        if(!toggleButton1.getState())
          dynamicGraph1.addDataPoint((int)(__HAL_TIM_GET_COUNTER(&htim3)/4));
        else
          dynamicGraph1.addDataPoint((int)(rand()%1000));
        frameCountUpdatePlotInterval = 0;
    }
...
void Screen2ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //NextScreen
        //When btn3 clicked change screen to Screen3
