...
/* Private defines -----------------------------------------------------------*/
#define ARDUINO_D15_Pin GPIO_PIN_8
#define ARDUINO_D15_GPIO_Port GPIOB
#define VSYNC_FREQ_Pin GPIO_PIN_4
#define VSYNC_FREQ_GPIO_Port GPIOB
#define ARDUINO_D14_Pin GPIO_PIN_9
#define ARDUINO_D14_GPIO_Port GPIOB
...
#define ARDUINO_D0_Pin GPIO_PIN_7
#define ARDUINO_D0_GPIO_Port GPIOC
