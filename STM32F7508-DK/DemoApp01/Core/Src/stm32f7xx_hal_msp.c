...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PB9     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = ARDUINO_D15_Pin|ARDUINO_D14_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(ARDUINO_D15_GPIO_Port, ARDUINO_D15_Pin);

    HAL_GPIO_DeInit(ARDUINO_D14_GPIO_Port, ARDUINO_D14_Pin);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = ARDUINO_D0_Pin|ARDUINO_D1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(GPIOC, ARDUINO_D0_Pin|ARDUINO_D1_Pin);
